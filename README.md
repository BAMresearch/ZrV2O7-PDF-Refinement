...
The unit cell of the ZrV₂O₇ structure considered in this refinement is large, containing approximately **1080 atoms** after expansion to the appropriate supercell. Consequently, the number of fitted parameters increases significantly as the refinement progresses and symmetry constraints are progressively relaxed to lower space groups (from Pa-3 to P1).

As a practical reference, refining the full series of symmetry reductions and rigid-body constraints on an **AMD Ryzen™ 7 PRO 7840U** processor, with approximately **80% CPU utilization**, typically takes about **36 hours** to complete all refinement steps. Users should consider these performance implications when planning refinements.
